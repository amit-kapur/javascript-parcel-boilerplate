...
var Header = function Header() {
  var template = "\n        <header>\n            <h1>My Parcel App</h1>\n            <p>This a boilerplate for a simple JS workflow using parcel</p>\n        </header>\n    ";
  return template;
};
